...
-   **MBA em Pesquisa Operacional e Tomada de Decisão** – BSB - _Cursando_\
    Fundamentos da PO, Programação Linear, otimização, métodos de agregação, análises de simulação e tomada de decisão

-   **MBA em Data Science & Analytics** – USP/ESALQ - 2022-2024\
    Estatística aplicada, machine learning (aprendizado supervisionado e não supervisionado), modelagem preditiva e prescritiva, otimização, Big Data e análise de dados.

-   **Engenharia Florestal** – UFPR | 2015 - 2021\
...
-   **Klabin S.A**. - Engenheiro de Planejamento Florestal \| 2021 - Atual\
    Atuação em planejamento estratégico, otimização, análise de dados e treinamento de colaboradores

-   **Tree Wood Products** – Estagiário de Suprimentos \| 2019 - 2020\
