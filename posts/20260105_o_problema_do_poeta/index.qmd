...
Reiterando o tópico de variávies de decisão (@sec-variaveis), especificamente a **Opção 2 - Com Limites**, caso seguissemos com uma declaração das variáveis usando o argumento `bounds`, não seria necessário a criação das restrições de área máxima, pois as variáveis já possuíriam um limite interno em suas próprias declarações.
...
6.  Finalizamos com a mesma estrutura para a variável $x_2$, acessando a área de nativa manejada, e logo após formando as casa decimais.
...
-   [Apostila - Programação Linerar para Fins Florestais (Antiga)](https://github.com/maykongpedro/maykon_pedro/blob/main/posts/20260105_o_problema_do_poeta/docs/Apostila_Programa%C3%A7%C3%A3o_Linear_Julio_Arce.pdf)
